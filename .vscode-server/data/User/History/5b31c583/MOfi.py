...
def writing_data(**kwargs):
    ...
    file_path = 'footbal_stadium_data_'+ str(datetime.now().date())
    ...
    df.to_csv(
        ...
        storage_options={
        "key": 'AKIAQEIP3OY734D354PC',
        "secret": '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',
        "token": 'vBguknLV1Zhag5F/7X/u4trVz61cGgoum+xDCovb',  # Remove this key if not using session tokens
        },
        index=False)
