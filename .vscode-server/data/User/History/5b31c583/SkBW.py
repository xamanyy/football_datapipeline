...
def writing_data(**kwargs):
    ...
    df.to_csv(
        ...
        storage_options={
        "key": 'ASIAQEIP3OY7YNKYBW22',
        "secret": 'TekqQXuPd0FH1BhFexLVls5b0/TMl3ZWSudSbVih',
        "token": 'FwoGZXIvYXdzEHoaDD2g3htaT/qv0wBjSyJqDzIG6ndRlGA7723xXMlHfv2deskJmHGG8cOM+axUXP18R7kun9HQnq+iD6DwNwZIw03xCy17+Lx/Fz/1fDcD9zPNnQiZKTDYNpAbprYkrTTbSiEPq3jB2OyAD9Gp/Jm9GbL9TIYMfk7ImiiW5JC6BjIovStP7MGo7vgI5G/FAOwUdo9lWuwkoxMCVrEk6NN+dGwz/apAIyrSkw=='
        },
        index=False)
