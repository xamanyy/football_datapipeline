...
def writing_data(**kwargs):
    ...
    df.to_csv(
        ...
        "token": 'FwoGZXIvYXdzEHoaDNMSnxztwwhHCAJBCyJqISKTXkz+Y9jmyCVeW6XLNcWDNgoOktj/YxE7RratM4j/Z3Peu8TSx2Ye0gCTCmRJ9rerXIsJcgvyNDVDNPX/UL0xfvTbF8o8A7f7XQImLYqtQ7nVmfl+J3WkBUK8n5iDRIBQmO13YB95OCiK6pC6BjIoP5gY/qMJRgHV0BSpRsbe9pp5WhZ78C3WZ5sZpobH/ZrI2xKbbTSv7w=='
        },
        index=False)
